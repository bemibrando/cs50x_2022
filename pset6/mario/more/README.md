...
- Write, in a file called `mario.py`, a program that recreates these half-pyramids using hashes (`#`) for blocks, exactly as you did in <a href="https://cs50.harvard.edu/x/2022/psets/1/">Problem Set 1</a>, except that your program this time should be written in Python.
...
- [CS50x - Pset6: Mario (more)](https://cs50.harvard.edu/x/2022/psets/6/mario/more/)
